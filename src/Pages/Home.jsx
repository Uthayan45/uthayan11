...
const WORDS = [" Computer Network & electronics Student"];
const TECH_STACK = ["Service now","React", "Javascript", "Node.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Uthayan45" },
  { icon: Linkedin, link: "www.linkedin.com/in/uthayanece" },
  { icon: Instagram, link: "" }
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Description */}
                <div className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div
  className={`
    relative z-10 w-full opacity-90 transform 
...
>
  <DotLottieReact
    ...
    // 🚫 Don't pass rendererSettings — it's not supported by DotLottieReact
  />
</div>
